        ...
        return (
            <div className="top-menu glass absolute h-8 w-full bg-slate-100/50 pl-5 pr-5 flex z-30">
                ...
                <div className="flex ml-auto top-menu-right">
                    <a href="https://www.linkedin.com/in/slava-trofimov-a1b919128/" className="linkedin tooltip tooltip-bottom" data-tip="LinkedIn">
                    ...
                    <a href="https://github.com/pmbstyle" className="github tooltip tooltip-bottom" data-tip="Github">
                    ...
                    <a href="https://www.facebook.com/vyacheslav.pmb" className="facebook tooltip tooltip-bottom" data-tip="Facebook">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3333 3333"
                            shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                            image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" width="20"
                            height="20">
                    ...
                    <a href="mailto:slava@trofimov.ca" className="email tooltip tooltip-bottom" data-tip="Email">
