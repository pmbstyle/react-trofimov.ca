...
const Clock = () => {
    ...
    return <span className="clock text-sm text-black">{time}</span>;
}

class TopMenu extends React.Component<TopMenuProps> {
    render() {
        return (
            <div className="top-menu glass absolute h-8 w-full bg-slate-100/50 pl-5 pr-5 flex z-30">
                <img src={Slava} className="tux" />
                <span className="text-black ml-3 text-sm window-title">{this.props.currentWindow}</span>
                <div className="flex ml-auto top-menu-right">
                    <a href="https://www.linkedin.com/in/slava-trofimov-a1b919128/" className="linkedin tooltip tooltip-bottom">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3333 3333"
                            ...
                            imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" width="20"
                            height="20">
                            <path
                    ...
                    <a href="https://github.com/pmbstyle" className="github tooltip tooltip-bottom">
                    ...
                    <a href="https://www.facebook.com/vyacheslav.pmb" className="facebook tooltip tooltip-bottom">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3333 3333"
                            shapeRendering="geometricPrecision" textRendering="geometricPrecision"
                            imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" width="20"
                            height="20">
                    ...
                    <a href="mailto:slava@trofimov.ca" className="email tooltip tooltip-bottom">
